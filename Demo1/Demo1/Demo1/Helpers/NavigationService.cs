...
namespace Demo1
{
		public class NavigationService : INavigationService
		{
			...
			public void NavigateTo(string pageKey)
			{
				...
				NavigationPage.SetHasBackButton(_navigation, true);
			}
			...
			{
				//			NavigationPage.SetHasBackButton (_navigation, visible);
				//			NavigationPage.SetHasNavigationBar (_navigation, visible);
				//			var x = NavigationPage.GetHasBackButton (_navigation);
				//			NavigationPage.SetHasBackButton (CurrentPage, visible);
				//			var y = NavigationPage.GetHasBackButton (CurrentPage);
